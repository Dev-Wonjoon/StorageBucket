...
const lazyHandlers: Record<string, () => Promise<IpcHandler>> = {
    'get-download-path': () =>
        import('./handlers/SystemHandler').then((m) => m.systemHandler['get-download-path']),
    'set-download-path': () =>
        import('./handlers/SystemHandler').then((m) => m.systemHandler['set-download-path']),
    'system:engine-install': () =>
        import('./handlers/SystemHandler').then((m) => m.systemHandler['system:engine-install']),
    'system:engine-licenses': () =>
        import('./handlers/SystemHandler').then((m) => m.systemHandler['system:engine-licenses']),
    'system:engine-status': () =>
        import('./handlers/SystemHandler').then((m) => m.systemHandler['system:engine-status']),
    'system:get-cookie-browser': () =>
        import('./handlers/SystemHandler').then(
            (m) => m.systemHandler['system:get-cookie-browser']
        ),
    'system:set-cookie-browser': () =>
        import('./handlers/SystemHandler').then(
            (m) => m.systemHandler['system:set-cookie-browser']
        ),
    'system:get-cookie-file': () =>
        import('./handlers/SystemHandler').then((m) => m.systemHandler['system:get-cookie-file']),
    'system:set-cookie-file': () =>
        import('./handlers/SystemHandler').then((m) => m.systemHandler['system:set-cookie-file']),
    'system:clear-cookie-file': () =>
        import('./handlers/SystemHandler').then((m) => m.systemHandler['system:clear-cookie-file']),

    'video:download': () =>
        import('./handlers/DownloadHandler').then((m) => m.downloadHandler['video:download']),
    'media:get-all': () =>
        import('./handlers/MediaHandler').then((m) => m.mediaHandler['media:get-all']),
    'media:delete': () =>
        import('./handlers/MediaHandler').then((m) => m.mediaHandler['media:delete']),
    'shell:show-item': () =>
        import('./handlers/MediaHandler').then((m) => m.mediaHandler['shell:show-item']),

    'favorite:get-all': () =>
        import('./handlers/FavoriteHandler').then((m) => m.favoriteHandler['favorite:get-all']),
    'favorite:toggle': () =>
        import('./handlers/FavoriteHandler').then((m) => m.favoriteHandler['favorite:toggle']),
    'favorite:check': () =>
        import('./handlers/FavoriteHandler').then((m) => m.favoriteHandler['favorite:check']),

    'tag:get-all': () => import('./handlers/TagHandler').then((m) => m.tagHandler['tag:get-all']),
    'tag:get-by-media': () =>
        import('./handlers/TagHandler').then((m) => m.tagHandler['tag:get-by-media']),
    ...
    'tag:add-to-media': () =>
        import('./handlers/TagHandler').then((m) => m.tagHandler['tag:add-to-media']),
    'tag:remove-from-media': () =>
        import('./handlers/TagHandler').then((m) => m.tagHandler['tag:remove-from-media']),
    'tag:bulk-add': () => import('./handlers/TagHandler').then((m) => m.tagHandler['tag:bulk-add']),
    'tag:bulk-remove': () =>
        import('./handlers/TagHandler').then((m) => m.tagHandler['tag:bulk-remove']),
    'tag:bulk-replace': () =>
        import('./handlers/TagHandler').then((m) => m.tagHandler['tag:bulk-replace']),

    'search:media': () =>
        import('./handlers/SearchHandler').then((m) => m.searchHandler['search:media']),
    'search:suggest-authors': () =>
        import('./handlers/SearchHandler').then((m) => m.searchHandler['search:suggest-authors']),
    'search:suggest-platforms': () =>
        import('./handlers/SearchHandler').then((m) => m.searchHandler['search:suggest-platforms']),
    'search:suggest-tags': () =>
        import('./handlers/SearchHandler').then((m) => m.searchHandler['search:suggest-tags']),
    ...
    'download:retry-job': () =>
        import ('./handlers/DownloadHandler').then((m) => m.downloadHandler['download:retry-job']),
}
